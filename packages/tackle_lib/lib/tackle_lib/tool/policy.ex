defmodule Tackle.Lib.Tool.Policy do
  ...
  * Tackle.Lib does not ask providers to run tool calls in parallel.
  ...
  @doc """
  Returns the default Tackle.Lib tool policy.
  """
  @spec default() :: t()
  ...
  tool execution, so Tackle.Lib filters them at the boundary.
  """
