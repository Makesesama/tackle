defmodule Tackle.Lib.Cancellation.Store.Ets do
  ...
  This module keeps Tackle.Lib's historical cancellation behaviour: a lazily-created
  named public ETS table shared by all processes in the VM. Hosts that prefer a
  different storage mechanism can implement `Tackle.Lib.Cancellation.Store` and set
