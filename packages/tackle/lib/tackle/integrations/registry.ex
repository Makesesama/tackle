defmodule Tackle.Integrations.Registry do
  @moduledoc """
  Small registry for exposing `Tackle.Tool` modules through external integrations.

  The core `Tackle.Tool.Registry` is optimized for agent-loop execution and stale
  ...
  @doc "Builds an integration registry from a list of `Tackle.Tool` modules."
  @spec new([module()]) :: t()
