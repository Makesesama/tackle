defmodule Tackle.Integrations.Anubis do
  @moduledoc """
  Integration helpers for exposing `Tackle.Tool` modules through Anubis MCP.
  ...
  alias Tackle.Integrations.Anubis.Schema, as: AnubisSchema
  alias Tackle.Integrations.Registry
  alias Tackle.Tool
  alias Tackle.Tool.{Call, Error, Result}
  ...
  @doc "Dispatches an Anubis tool call to a registered `Tackle.Tool` module."
  ...
  defp call_id(opts), do: Keyword.get_lazy(opts, :call_id, &Tackle.ID.uuid4/0)
end
