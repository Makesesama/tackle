defmodule Tackle.CLI.TUI.State do
  ...
  defstruct agent_ref: nil,
            ...
            spinner_frame: 0,
            metrics: %Metrics{},
            observations: %Tackle.CLI.TUI.Observations{},
            tool_activity: [],
            subagents: %{},
            activity: nil,
            compactions: [],
